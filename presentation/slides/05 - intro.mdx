...
<!-- block-start: column -->
<!-- classes: grid.sm -->
![Example Vue2 - parent](../../code/examples/vue2-issues-1/screenshot.png)
[Example Vue2 - parent](http://127.0.0.1:8085/examples/vue2-issues-1)

<!-- block-end -->
<!-- block-start: column -->
![Example Vue2 - child](../../code/examples/vue2-issues-1/screenshot2.png)
[Example Vue2 - child](http://127.0.0.1:8085/examples/vue2-issues-1)
